...
from google.cloud.proto.speech.v1 import cloud_speech_pb2 #updated? double check
#from google.cloud.speech import cloud_speech_pb2
...
def listen_print_loop(recognize_stream):
    ...
    for resp in recognize_stream:
        ...
        if not result.is_final:
            ...
            # one of our keywords.
#            if re.search(r'over', transcript, re.I):
#                print('Exiting..')
#                break
...
def mainspeech():
    ...
    with record_audio(RATE, CHUNK) as buffered_audio_data:
        ...
        try:
            return (listen_print_loop(recognize_stream))
